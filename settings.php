<?php
define('C_REST_CLIENT_ID','');//Application ID я это убрал
define('C_REST_CLIENT_SECRET','');//Application key я это убрал
// or
define('C_REST_WEB_HOOK_URL','');//url on creat Webhook я это убрал
